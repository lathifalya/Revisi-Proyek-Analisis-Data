...
# If 'All' is selected, combine 'casual' and 'registered' into one
if 'All' in selected_user_type:
    filtered_df['total'] = filtered_df['casual'] + filtered_df['registered']
    selected_user_type = ['total']  # Only show the combined total

# Filter and group data by month and season, summing the selected user types
...
# Plot for each selected user type
